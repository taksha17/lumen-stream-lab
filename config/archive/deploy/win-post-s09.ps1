# S09: export -> deploy -> domain gate -> regression (rollback on gate fail)
$ErrorActionPreference = "Stop"
$LabRoot = "D:\lumen-stream-lab"
$Gguf = "$LabRoot\exports\qwen2.5-3b-lumen-s09.q4_k_m.gguf"
$S07Gguf = "$LabRoot\exports\qwen2.5-3b-lumen-s07.q4_k_m.gguf"
$ModelName = "qwen2.5-3b-lumen"

& "$LabRoot\deploy\win-export-3b-s09.ps1"
...
Write-Host "`n=== S09 domain gate ===" -ForegroundColor Cyan
...
Write-Host "`n=== S09 regression gate ===" -ForegroundColor Cyan
...
Write-Host "`n=== S09 PROMOTED to production ===" -ForegroundColor Green
